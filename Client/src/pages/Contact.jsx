        ...
        >
          <div style={{ width: "100%", maxWidth: "400px", padding: "2rem" }}>
            ...
            <p style={{ marginBottom: "1.5rem", color: "#6B7280" }}>
              Mari berkenalan dengan <strong>THRIFT.GARAGE</strong>, info
              selengkapnya ada dibawah sini..
            </p>
            <ul>
              <li>Thrift.Garage@gmail.com</li>
              <li>+62 812 345 6789</li>
              <li>Jl.Kebon Kopi, Cimahi, Indonesia</li>
            </ul>
            <div
              style={{
                textAlign: "center",
            ...
            >
              Jangan lupa ya hubungi kami, Let's Order Now Gang
            </h2>
            <p style={{ fontStyle: "italic", color: "#9CA3AF" }}>
              “Kami percaya, setiap barang punya cerita. Yuk, temukan gaya kamu
              bersama kami!”
            </p>
          </div>
        </div>
